...
defined('DIR_CONFIG') || define('DIR_CONFIG', DIR_ROOT . 'config' . DIRECTORY_SEPARATOR);
defined('DIR_SYSTEM') || define('DIR_SYSTEM', DIR_ROOT . 'system' . DIRECTORY_SEPARATOR);
...
if (! defined('PUBLIC_PATH')) {
	...
	define('PUBLIC_THEME_PATH', '/public/');
}
